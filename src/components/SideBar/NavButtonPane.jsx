...
var User = <FaUser className="icon-nav-button"/>;
var FaFileText = require('react-icons/lib/fa/file-text');
var FileText = <FaFileText className="icon-nav-button"/>;
var FaPaintBrush = require('react-icons/lib/fa/paint-brush');
var PaintBrush = <FaPaintBrush className="icon-nav-button"/>;
var FaEllipsis = require('react-icons/lib/fa/ellipsis-h');
var Ellipsis = <FaEllipsis className="icon-nav-button"/>;
